...
<div class="grid-x grid-margin-x">
	...
	<div class="cell medium-4">
		<div class="has-white-background-color padding-1">
			...
			<ul class="no-bullet">
				<li>
					<a href="<?php the_permalink('45850') ?>/#software-entwicklung">
						Software-Entwicklung
					</a>
				</li>
				<li>
					<a href="<?php the_permalink('45850') ?>/#produktmanagement">
						Produktmanagement
					</a>
				</li>
				<li>
					<a href="<?php the_permalink('45850') ?>/#community-kommunikation">

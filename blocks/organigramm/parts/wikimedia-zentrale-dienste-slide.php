...
<div class="grid-x grid-margin-x">
	...
	<div class="cell medium-4">
		<div class="has-white-background-color padding-1">
			...
			<ul class="no-bullet">
				<li>
					<a href="<?php the_permalink('45850') ?>/#zentrale-dienste">
						Zentrale Dienste
					</a>
				</li>
				<li>
					<a href="<?php the_permalink('45850') ?>/#officemanagement">
						Office Management
					</a>
				</li>
				<li>
					<a href="<?php the_permalink('45850') ?>/#spenden-und-mitglieder">
						Spenden und Mitglieder
					</a>
				</li>
				<li>
					<a href="<?php the_permalink('45850') ?>/#eventmanagement">
						Eventmanangement
					</a>
				</li>
			</ul>

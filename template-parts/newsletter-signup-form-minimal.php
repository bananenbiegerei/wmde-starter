<div class="flex flex-col space-y-4">
    <h3 for="newsletter-signup-form" class="text-primary text-base"><?php_e('Newlsetter Anmeldung'); ?></h3>
    <form action="https://t874ad7c5.emailsys1a.net/191/2155/d537ac9314/subscribe/form.html" method="post" id="newsletter-signup-form">
        ...
        <ul class="no-bullet newsletter-form-minimal relative">
            <li style="position:absolute; z-index: -100; left:-6000px;" aria-hidden="true">
                <label class="field_label required" for="rm_email"><?php_e('E-Mail:'); ?> </label>
            ...
            <li>
                <label class="field_label required sr-only" for="email"><?php_e('E-Mail:'); ?> * </label>
            ...
            <li class="form_button absolute right-1 bottom-1">
                <input type="submit" class="form_button_submit btn btn-primary btn-sm" value="<?php_e('Anmelden'); ?>" />
            </li>
        </ul>
    </form>
</div>

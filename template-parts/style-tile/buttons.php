...
<div class="space-y-5">
	...
	<button type="button" class="btn btn-sm btn-icon-left">
	...
	<button type="button" class="btn hollow btn-icon-left">
	...
	<button type="button" class="btn btn-lg btn-icon-left">
	...
	<button type="button" class="btn btn-xl btn-icon-left">
	...
	<button type="button" class="btn btn-xs btn-icon-left-only">
	...
	<button type="button" class="btn btn-sm btn-icon-left-only">
	...
	<button type="button" class="btn btn-icon-left-only">
	...
	<button type="button" class="btn btn-lg btn-icon-left-only">
	...
	<button type="button" class="btn btn-xl btn-icon-left-only">

...
<?php if (has_post_thumbnail()): ?>
  <div class="min-h-[12rem] rounded-b-3xl check-color-contrast" style="background-color:<?= $header_bg ?>;">
	  <div class="container md:grid grid-cols-12 gap-10 <?= $color_contrast ? 'white-scheme' : ''?>">
		  ...
		  <div class="md:col-span-6 lg:col-span-9">
				  ...
				  <h1 class="uppercase font-bold font-alt text-sm my-5" style="color:<?= $secondary_color ?>"><?php the_title(); ?></h1>
				  <?php else: ?>

...
<ul class="list-none flex gap-2 items-center" id="social-media-menu">
  ...
  <li>
  <a class="btn btn-ghost btn-sm" href="<?= $url ?>" target="_blank" rel="me">
  ...
  <li>
  <a class="btn btn-ghost btn-sm" href="<?= $url ?>" target="_blank" rel="me"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"  alt="linkedin Logo">
  ...
  <li>
  <a class="btn btn-ghost btn-sm" href="<?= $url ?>" target="_blank" rel="me"> <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512"  alt="Facebook Logo">
  ...
  <li>
  <a class="btn btn-ghost btn-sm" href="<?= $url ?>" rel="me" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  alt="Mastodon Logo">

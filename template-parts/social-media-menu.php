...
<ul class="list-none flex gap-2 items-center" id="social-media-menu">
  ...
  <li>
  <a class="btn btn-primary btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank">
  ...
  <li>
  <a class="btn btn-primary btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 16 16"  alt="linkedin Logo">
  ...
  <li>
  <a class="btn btn-primary btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512"  alt="Facebook Logo">
  ...
  <li>
  <a class="btn btn-primary btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24"  alt="Mastodon Logo">

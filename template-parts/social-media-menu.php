...
<ul class="list-none flex gap-2 items-center" id="social-media-menu">
  ...
  <a class="btn btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1024 1024">
  ...
  <a class="btn btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank">
    ...
    <defs>
      ...
      <rect width="21.9048" height="22.8571" fill="white" transform="translate(9.52344 8.57141)" />
      </clipPath>
    </defs>
    </svg>
  ...
  <li>
  <a class="btn btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 16 16">
  ...
  <li>
  <a class="btn btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512">
  ...
  <li>
  <a class="btn btn-ghost btn-icon-only" href="<?= $url ?>" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24">

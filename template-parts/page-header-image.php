...
var_dump($img_position);
?>
<div
    class="rounded-bl-xl rounded-br-xl bg-gray-light mb-10 h-auto lg:h-[30rem] rounded-bl-xl rounded-br-xl overflow-hidden relative text-white">
    <div class="container py-10 grid grid-cols-1 content-between h-full">
        <div class="mb-10">
    ...
    <div class="absolute top-0 left-0 w-full h-full -z-10">
        <?php the_post_thumbnail('full', ['class' => '-mb-10 object-contain h-full w-full ' . $img_position]); ?>
    </div>
    <?php } ?>
</div>

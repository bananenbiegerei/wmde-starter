...
?>
<div class="nohover:mt-12 rounded-bl-xl rounded-br-xl bg-neutral-light mb-10 h-auto lg:h-[30rem] rounded-bl-xl rounded-br-xl overflow-hidden relative text-white">
    ...
    <div class="absolute top-0 left-0 w-full h-full -z-10 bg-warning">

...
<div id="navmenu_mobile" x-data="navMenuMobile" class="z-40 block bg-white fixed left-0 right-0  bottom-0 top-14 block md:hidden nohover:block overflow-scroll" x-show="$store.open_mobile_nav"

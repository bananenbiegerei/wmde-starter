...
<header aria-hidden="true" tabindex='-1' id="titlebar_mobile" class="flex bg-white h-14 items-center py-1 px-5 left-0 right-0 fixed  border-b border-neutral-200 z-40  md:hidden nohover:flex">

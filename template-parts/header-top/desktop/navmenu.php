...
<header role="banner" id="navmenu_desktop" aria-hidden="true" tabindex='-1' x-data="navMenu" class="border-b border-gray-200 sticky top-0 z-40 bg-white py-1 hidden md:block nohover:hidden" @mouseleave="closeNav()">

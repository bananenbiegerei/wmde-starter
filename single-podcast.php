...
<div class="bg-primary py-5 nohover:mt-20">
  <div class="container">
  <a href="<?php echo get_permalink('63101'); ?>">
    <img class="max-w-[160px] lg:max-w-xs h-auto max-h-[80px] lg:max-h-44 w-auto" src="<?php echo get_stylesheet_directory_uri(); ?>/img/wikimove/wikimove-logo.png" alt="Logo">
  </a>
  </div>
</div>
<div class="bg-primary-200 py-5">
  ...
  <div class="grid grid-cols-12 mb-5 mt-10">
    ...
    <?php echo get_field('embeded_player'); ?>
    </div>
  </div>
  <?php endif; ?>
  </div>

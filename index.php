...
<div class="mt-20 container flex flex-col space-y-20">
    ...
    <div class="flex items-center justify-between border-t border-neutral-light bg-white py-3">
        ...
        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between sm:items-center">
            <div>
                <p class="text-sm text-primary">
                    ...
                    <span class="font-medium"><?php echo(($wp_query->query['paged'] ?? 1) - 1) * $wp_query->post_count + 1; ?></span>
                    <?php _e('bis', BB_TEXT_DOMAIN); ?>
                    <span class="font-medium"><?php echo(($wp_query->query['paged'] ?? 1) - 1) * $wp_query->post_count + $wp_query->post_count; ?></span>

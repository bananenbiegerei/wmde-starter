...
<div class="tribe-events-meta-group-details">
	<h2 class="topline"> <?php esc_html_e( 'Details', 'the-events-calendar' ); ?> </h2>
	<dl class="mt-2 text-xl font-normal">
		<?php
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<dt class=""> <?php esc_html_e( 'Start:', 'the-events-calendar' ); ?> </dt>
			<dd class="mb-3">
				<abbr class="tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
			</dd>

			<dt class="tribe-events-end-date-label"> <?php esc_html_e( 'End:', 'the-events-calendar' ); ?> </dt>
			<dd class="mb-3">
				<abbr class="tribe-events-end-date dtend" title="<?php echo esc_attr( $end_ts ); ?>"> <?php echo esc_html( $end_date ); ?> </abbr>
			</dd>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<dt class=""> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?> </dt>
			<dd cla>
				<abbr class="tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
			</dd>
		...
		elseif ( tribe_event_is_multiday() ) :
			...
			<dt class=""> <?php esc_html_e( 'Start:', 'the-events-calendar' ); ?> </dt>
			<dd class="mb-3">
				<abbr class="tribe-events-start-datetime updated published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_datetime ); ?> </abbr>
				<?php if ( $show_time_zone ) : ?>
					<span class="tribe-events-time-zone published "><?php echo esc_html( $time_zone_label ); ?></span>
				<?php endif; ?>
			</dd>

			<dt class=""> <?php esc_html_e( 'End:', 'the-events-calendar' ); ?> </dt>
			<dd class="mb-3">
				<abbr class="tribe-events-end-datetime dtend" title="<?php echo esc_attr( $end_ts ); ?>"> <?php echo esc_html( $end_datetime ); ?> </abbr>
				<?php if ( $show_time_zone ) : ?>
					<span class="tribe-events-time-zone published "><?php echo esc_html( $time_zone_label ); ?></span>
				<?php endif; ?>
			</dd>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<dt class=""> <?php esc_html_e( 'Cost:', 'the-events-calendar' ); ?> </dt>
			<dd class="mb-3"> <?php echo esc_html( $cost ); ?> </dd>
		<?php endif ?>
		...
		echo tribe_get_event_categories(
			...
			[
				...
				'label_before' => '<dt class="">',
				'label_after'  => '</dt>',
				'wrap_before'  => '<dd class="mb-3">',
				'wrap_after'   => '</dd>',
			]
		);
		?>
		...
		if ( ! empty( $website ) ) : ?>
			<?php if ( ! empty( $website_title ) ): ?>
				<dt class=""> <?php echo esc_html( $website_title ); ?> </dt>
			<?php endif; ?>
			<dd class="mb-3"> <?php echo $website; ?> </dd>
		<?php endif ?>

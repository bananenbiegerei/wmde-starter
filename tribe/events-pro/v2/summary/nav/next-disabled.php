...
/* translators: %s: Event (plural or singular). */
$events_mobile_friendly_label = sprintf( __( 'Next %1$s', 'tribe-events-calendar-pro' ), '<span class="tribe-events-c-nav__next-label-plural tribe-common-a11y-hidden sr-only">' . tribe_get_event_label_plural() . '</span>' );
?>

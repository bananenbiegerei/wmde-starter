...
?>
<div class="tribe-block tribe-block__organizer__details tribe-clearfix mt-0">
	<h3 class="!text-2xl">Organisator</h3>
	<div class="tribe-block__organizer__title">
		<h4><?php echo tribe_get_organizer_link( $organizer ); ?></h4>
	</div>
	<?php if ( ! empty( $phone ) ) : ?>
	...
	<?php endif; ?>
	<?php if ( ! empty( $email ) ) : ?>
		<p class="tribe-block__organizer__emails"><?php echo esc_html( $email ); ?></p>
	<?php endif; ?>
</div>

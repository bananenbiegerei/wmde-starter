...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<h2 class="tribe-events-single-section-title sr-only"> <?php esc_html_e( 'Details', 'the-events-calendar' ); ?> </h2>
	<dl class="mt-2 text-xl font-normal">
		...
		// Single day events
			...
			<dt class="tribe-events-start-date-label text-base"> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?> </dt>
			<dd class="mb-5">
				<abbr class="tribe-events-abbr tribe-events-start-date published dtstart no-underline" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
			</dd>

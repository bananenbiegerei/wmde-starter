    ...
    <div class="col-span-12 mb-10 lg:mb-20">
        ...
        <div x-data="{selectedFilter: ''}">
            <div class="btn-group mb-5">
                <button x-on:click="selectedFilter=''" class="btn" :class="{'btn-active': selectedFilter}" type="button"> Alle (<?php echo count($results); ?>) </button>
                <?php foreach ($post_types as $term => $label): ?>
                <button x-on:click="selectedFilter='<?php echo $term; ?>'" class="btn" :class="{'btn-active': selectedFilter != '<?php echo $term; ?>'}" type="button">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                ...
                <a href="<?php echo $result[
                	'permalink'
                ]; ?>" class="bb-card-block text-hover-effect image-hover-effect bg-gray rounded-xl overflow-hidden mb-10 lg:mb-5 z-10 hover:z-20 relative" x-show="!selectedFilter || '<?php echo $result[
	'post_type'
]; ?>' == selectedFilter">

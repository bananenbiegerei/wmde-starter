...
// Fallback thumbnail
$fallback_thumbnail = wp_get_attachment_image((get_post_thumbnail_id(get_option('page_on_front')) ?: get_post_thumbnail_id(get_option('page_for_posts'))), [400, 0], false, ['class' => 'h-full w-full object-cover']);
